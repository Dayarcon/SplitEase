...
export default function SignUp() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #F5F3FF 0%, #EDE9FE 50%, #F0F9FF 100%)", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 16px" }}>
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 24, boxShadow: "0 8px 40px rgba(124,58,237,0.10), 0 2px 8px rgba(0,0,0,0.06)", padding: "40px 36px" }}>
            <h1 style={{ fontSize: 28, fontWeight: 800, color: "#0f172a", textAlign: "center", marginBottom: 6 }}>Create Account</h1>
            <p style={{ fontSize: 14, color: "#64748b", textAlign: "center", marginBottom: 24 }}>Start splitting expenses with ethereal ease.</p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, color: "#94a3b8", letterSpacing: "0.8px", textTransform: "uppercase", whiteSpace: "nowrap" }}>OR USE EMAIL</span>
              <div style={{ flex: 1, height: 1, background: "#e2e8f0" }} />
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <input
                  ...
                  required
                  autoComplete="name"
                  style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: 12, fontSize: 14, color: "#0f172a", background: "#F8FAFC", outline: "none", boxSizing: "border-box" }}
                />
              </div>
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    style={{ width: "100%", padding: "12px 44px 12px 14px", border: "1px solid #e2e8f0", borderRadius: 12, fontSize: 14, color: "#0f172a", background: "#F8FAFC", outline: "none", boxSizing: "border-box" }}
                  />
                  <button
                    type="button"
                ...
                <p style={{ fontSize: 11, color: "#94a3b8", marginTop: 4 }}>At least 6 characters</p>
              </div>
              ...
              <label style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 22, cursor: "pointer" }}>
                ...
                <span style={{ fontSize: 13, color: "#374151", lineHeight: 1.5 }}>
                  I agree to the{" "}
                  <span style={{ color: PURPLE, fontWeight: 600 }}>Terms of Service</span>
                  {" "}and{" "}
                  <span style={{ color: PURPLE, fontWeight: 600 }}>Privacy Policy</span>
                </span>
              </label>
              ...
              <button
                type="submit"
                disabled={loading}
                style={{ width: "100%", padding: "13px", background: loading ? "#a78bfa" : PURPLE, color: "#fff", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
              >
                {loading ? (
                  <>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginTop: 18 }}>
              ...
              <span style={{ fontSize: 11, color: "#94a3b8", fontWeight: 500, letterSpacing: "0.5px", textTransform: "uppercase" }}>SECURE SSL ENCRYPTED CONNECTION</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: "rgba(255,255,255,0.5)", borderTop: "1px solid rgba(255,255,255,0.8)", padding: "16px 40px", textAlign: "center" }}>
